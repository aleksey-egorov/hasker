...
Приложение должно быть доступно по адресу http://localhost:8080 . Для отправки почты из приложения вам нужно будет указать соответствующие реквизиты в hasker/custom.py, после чего перезапустить приложение.
